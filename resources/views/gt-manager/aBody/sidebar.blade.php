<nav class="sidebar">
    ...
    <div class="sidebar-body">
        <ul class="nav">
            ...
            <li class="nav-item">
                <a class="nav-link" data-toggle="collapse" href="#cstTheme" role="button" aria-expanded="false" aria-controls="cstTheme">
            ...
            <li class="nav-item">
                <a class="nav-link" data-toggle="collapse" href="#BlogSystem" role="button" aria-expanded="false" aria-controls="BlogSystem">
                ...
                <div class="collapse" id="BlogSystem">
                    <ul class="nav sub-menu">
                        ...
                        <li class="nav-item"><a href="pages/email/compose.html" class="nav-link">Add Categorie</a></li>
                        <li class="nav-item"><a href="pages/email/read.html" class="nav-link">Categories List</a></li>
                    </ul>
                </div>
            </li>
            {{-- END 2nd Section --}}
            ...
            <li class="nav-item">
                <a class="nav-link" data-toggle="collapse" href="#CarsForSale" role="button" aria-expanded="false" aria-controls="CarsForSale">
            ...
            <li class="nav-item">
                <a class="nav-link" data-toggle="collapse" href="#ProductOrders" role="button" aria-expanded="false" aria-controls="ProductOrders">
                ...
                <div class="collapse" id="ProductOrders">
                    <ul class="nav sub-menu">
                        <li class="nav-item"><a href="pages/advanced-ui/cropper.html" class="nav-link">All Orders</a></li>
            ...
            <li class="nav-item">
                <a class="nav-link" data-toggle="collapse" href="#admins" role="button" aria-expanded="false" aria-controls="admins">
